...
D_l = lens_factor * lambda_0; % lens diameter
...
%  Truncated lens 
D = lens_factor * lambda_0; % lens diameter
theta_0_truncated = deg2rad(theta_max_truncated_deg); % angular domain of the truncated lens
e = 1 / sqrt(er);
...
%% 6.Give an estimation of the directivity and gain of the lens antenna
